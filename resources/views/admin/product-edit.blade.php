...
<div class="main-content">
    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- form-add-product -->
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="admin.product.update">
                @csrf
                @method('PUT')
    ...
    <div class="bottom-page">
        <div class="body-text">Copyright © 2024 TrendMart</div>
    </div>
</div>
